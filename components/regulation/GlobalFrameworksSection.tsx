...
export function GlobalFrameworksSection() {
  return (
    <>
      <SectionDivider />
      <section aria-labelledby="the-regulatory-wave-heading" className="section-alt relative py-28">
        <div className="relative z-10 mx-auto max-w-5xl px-6">
          <FadeIn>
            <h2 id="the-regulatory-wave-heading" className="text-3xl font-bold tracking-tight">
              The Regulatory Wave
            </h2>
            <p className="mt-3 text-base text-[var(--text-muted)]">
              ...
              resolution. ETC&rsquo;s regulatory profile travels well: it qualifies
