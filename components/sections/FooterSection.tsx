            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-4 flex items-center gap-3">
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-lg bg-[rgba(255,255,255,0.04)] text-[var(--text-subtle)] transition-colors hover:bg-[rgba(255,255,255,0.08)] hover:text-white"
                >
