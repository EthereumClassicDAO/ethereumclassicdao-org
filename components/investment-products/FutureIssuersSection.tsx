...
export function FutureIssuersSection() {
  return (
    <>
      <SectionDivider />
      <section aria-labelledby="the-investment-product-landscape-heading" className="section-gradient relative py-28">
        <div className="relative z-10 mx-auto max-w-5xl px-6">
          <FadeIn>
            <h2 id="the-investment-product-landscape-heading" className="text-3xl font-bold tracking-tight">
          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-2">
            ...
            <FadeIn delay={80}>
              <div>
                <p className="text-xs font-mono uppercase tracking-wider text-[var(--color-orange)]">
            ...
            <FadeIn delay={160}>
              <div>
                <p className="text-xs font-mono uppercase tracking-wider text-[var(--color-violet)]">
