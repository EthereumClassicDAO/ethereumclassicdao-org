...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "No. Block rewards remain completely untouched at 2.048 ETC (Era 4). The Olympia upgrade redirects the EIP-1559 basefee to the protocol treasury — this is separate from miner rewards.",
  },
  {
